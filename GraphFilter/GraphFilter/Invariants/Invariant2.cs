...
{
    public class Invariant2
    {
        /*
    #region numerics
    public static int MaxDegree(Graph g) { return MaxDegree.}
    ...
    public static int CliqueNumber(Graph g) { return Invariants.CliqueNumber.Calculate(g); }
    ...
    public static int ChromaticNumber(Graph g) { return Invariants.ChromaticNumber.Calculate(g); }
    public static int IndependenceNumber(Graph g) { return Invariants.CliqueNumber.IndependenceNumber(g); }
